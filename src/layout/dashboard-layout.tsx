...
export default function DashboardLayout() {
  ...
  return (
    <div className="relative flex flex-1 p-[0.7rem] bg-content2">
      <div
        className={cn(
      ...
      <div
        className={cn(
          "absolute top-0 lg:static h-screen ml-[-0.7rem] lg:ml-[-0.7rem] lg:h-auto border-r border-divider lg:border-none rounded-tr-xl rounded-br-xl flex flex-col bg-content2 w-[17rem] px-[0.7rem] overflow-x-hidden duration-300 space-y-8 z-40",
          !sidebarOpen && "ml-[-17rem] lg:ml-[-17rem] border-none"
        )}
      >
        ...
        <div className="flex flex-col space-y-2">
          ...
          <SidebarItem
            icon={faUserGroup}
            active={location.pathname === "/dashboard/group"}
            onPress={() => sidebarNavigate("/dashboard/group")}
          >
            Group
          </SidebarItem>
          <SidebarItem
            icon={faUserGroup}
            active={location.pathname === "/dashboard/inscriptions"}
            onPress={() => sidebarNavigate("/dashboard/inscriptions")}
          >
            Inscriptions
          </SidebarItem>
        </div>
      ...
      <div className="flex flex-1 flex-col rounded-2xl bg-background border-divider border">
